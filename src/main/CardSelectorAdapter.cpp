...
: mFileOccurrence(FileOccurrence::FIRST),
  ...
  mSuccessfulSelectionStatusWords({CardSelectorAdapter::DEFAULT_SUCCESSFUL_CODE}) {}

CardSelectorSpi& CardSelectorAdapter::filterByCardProtocol(const std::string& cardProtocol)
{
